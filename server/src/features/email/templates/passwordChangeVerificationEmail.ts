type PasswordChangeVerificationTemplateInput = {
  verificationUrl: string;
};

export const passwordChangeVerificationTemplate = ({
  verificationUrl,
}: PasswordChangeVerificationTemplateInput) => {
  return `
  <div style="font-family: Arial, sans-serif; background-color: #f8fafc; padding: 32px;">
    <div style="max-width: 520px; margin: 0 auto; background-color: #ffffff; border: 1px solid #e5e7eb; border-radius: 12px; padding: 32px;">
      ...
      <h1 style="margin: 0 0 16px; font-size: 24px; line-height: 1.3; color: #0f172a;">
        Bestätige deine Passwortänderung
      </h1>

      <p style="margin: 0 0 24px; font-size: 15px; line-height: 1.6; color: #475569;">
        Für deinen FlowDesk-Account wurde eine Änderung des Passworts angefordert.
        Bitte bestätige diese Änderung, damit dein neues Passwort aktiviert werden kann.
      </p>
