...
describe("handleTaskOverdueNotifications", () => {
  it("publishes realtime notifications to overdue task collaborators", async () => {
    ...
    const deadlineAt = new Date("2026-07-29T09:00:00.000Z").toISOString();

    await handleTaskOverdueNotifications({
      workspaceId,
      taskId,
      projectId,
      collaboratorIds,
